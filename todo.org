* TODO categories can have customizable colors
* TODO better styling
dashboard:
- no rounded corners, especially on cards
- "collapse-content" should have distinct background color, except for at the bottom: there should be padding/margin (unsure which one) to have distance to the next category, to make it visually more part of its category divider. The visual should be like folders opening/closing for categories (un-)collapsing.
